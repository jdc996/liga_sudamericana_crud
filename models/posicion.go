...
type Posicion struct {
	...
	Puntaje           int `orm:"column(puntaje)"`
	EquipoId          int `orm:"column(equipo_id)"`
	PartidosJugados   int `orm:"column(partidos_jugados)"`
	PartidosGanados   int `orm:"column(partidos_ganados)"`
	PartidosEmpatados int `orm:"column(partidos_empatados)"`
	PartidosPerdidos  int `orm:"column(partidos_perdidos)"`
	GolesFavor        int `orm:"column(goles_favor)"`
	GolesContra       int `orm:"column(goles_contra)"`
	DiferenciaGoles   int `orm:"column(diferencia_goles)"`
}
